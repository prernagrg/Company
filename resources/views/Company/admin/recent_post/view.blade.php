...
<div class="container py-4 ">
   ...
   <div class="shadow p-3 ">
    <form action="{{route('Recent_posts.store',$recent_post->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="my-3 ">
        ...
        <div class="my-3 ">
            ...
            <input type="text" @readonly(true) value="{{$recent_post->title}}" class="form-control" name="title" placeholder="write the Name here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">date</label>
            <input type="text" @readonly(true) value="{{$recent_post->date}}" name="date" class="form-control" placeholder="Write the date here">
        </div>
