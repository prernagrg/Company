...
<div class="container py-4 ">
   ...
   <div class="shadow p-3 ">
    <form action="{{route('Web.show',$web->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="my-3 ">
        ...
        <div class="my-3 ">
            ...
            <input type="text" @readonly(true) value="{{$web->title}}" class="form-control" name="title" placeholder="write the title here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">sub title</label>
            <input type="text" @readonly(true) value="{{$web->sub_title}}" name="sub_title" class="form-control" placeholder="Write the sub_title here">
        </div>
