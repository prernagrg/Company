...
<div class="container py-4 ">
   ...
   <div class="shadow p-3 ">
    <form action="{{route('Portfolio_img.update',$portfolio_img->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="my-3 ">
           ...
           <img src="{{asset('uploads/' . $portfolio_img->img)}}" width="25%" height="auto" alt="">
        </div>
        <div class="my-3">
