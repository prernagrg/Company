   ...
   <div class="shadow p-3 ">
    <form action="{{route('Comments.update',$comment->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 ">
            ...
            <input type="text" value="{{$comment->name}}" class="form-control" name="name" placeholder="write the Name here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">date</label>
            <input type="text" value="{{$comment->date}}" name="date" class="form-control" placeholder="Write the date here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">description</label>
            <textarea type="text" rows="2" name="description" class="form-control" placeholder="Write the description here">{{$comment->description}}</textarea>
        </div>
        <div class="my-3">
