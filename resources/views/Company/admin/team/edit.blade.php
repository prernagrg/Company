   ...
   <div class="shadow p-3 ">
    <form action="{{route('Team.update',$team->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 ">
            ...
            <input type="text" class="form-control" value="{{$team->name}}" name="name" placeholder="write the Name here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">Position</label>
            <input type="text" name="position" value="{{$team->position}}" class="form-control" placeholder="Write the position here">
        </div>
        <div class="my-3">
