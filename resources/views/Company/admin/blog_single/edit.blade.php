...
<div class="container py-4 ">
   ...
   <div class="shadow p-3 ">
    <form action="{{route('Blog_single.update',$blog_single->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="my-3 ">
        ...
        <div class="my-3 ">
            ...
            <input type="text" value="{{$blog_single->title}}" class="form-control" name="title" placeholder="write the title here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">quote</label>
            <input type="text" value="{{$blog_single->quote}}" name="quote" class="form-control" placeholder="Write the quote here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">description</label>
            <textarea type="text" rows="2" name="description" class="form-control" placeholder="Write the description here">{{$blog_single->description}}</textarea>
        </div>
        <div class="my-3">
