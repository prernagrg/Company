...
<a href="{{route('Services.create')}}" class="btn btn-md btn-secondary float-end">Create Services</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-info btn-sm " href="{{route('Services.show',$service->id)}}" role="button">View</a>
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal{{$service->id}}">
                    Delete
                  </button>
                      ...
                      <div class="modal-dialog  ">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel{{$service->id}}">Modal title</h5>
