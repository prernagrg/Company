   ...
   <div class="shadow p-3 ">
    <form action="{{route('Card.update',$card->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 ">
            ...
            <input type="text" value="{{$card->title}}" class="form-control" name="title" placeholder="write the title here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">sub title</label>
            <input type="text" value="{{$card->sub_title}}" name="sub_title" class="form-control" placeholder="Write the sub_title here">
        </div>
        <div class="my-3">
