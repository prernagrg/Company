...
<div class="container py-4 ">
    <a class="btn btn-secondary btn-md float-end m-3" href="{{route('Card.index')}}" role="button">View card  </a>
   <div class="shadow p-3 ">
    <form action="{{route('Card.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 ">
            ...
            <input type="text" name="sub_title" class="form-control" placeholder="Write the sub_title here">
        </div>
        <div class="my-3">
