   ...
   <div class="shadow p-3 ">
    <form action="{{route('App.update',$app->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 ">
           ...
           <img src="{{asset('uploads/' . $app->img)}}" width="25%" height="auto" alt="">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">title</label>
            <input type="text" value="{{$app->title}}" class="form-control" name="title" placeholder="write the title here">
        </div>
        <div class="my-3 ">
            <label for="" class="form-label">sub title</label>
            <input type="text" value="{{$app->sub_title}}" name="sub_title" class="form-control" placeholder="Write the sub_title here">
        </div>
        <div class="my-3">
